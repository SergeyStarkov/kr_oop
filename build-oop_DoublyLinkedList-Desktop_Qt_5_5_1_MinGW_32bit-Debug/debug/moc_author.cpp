...
#include "../../oop_DoublyLinkedList/author.h"
...
struct qt_meta_stringdata_author_t {
    QByteArrayData data[4];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_author_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_author_t qt_meta_stringdata_author = {
    {
QT_MOC_LITERAL(0, 0, 6), // "author"
QT_MOC_LITERAL(1, 7, 16), // "on_start_clicked"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 10) // "slot_timer"

    },
    "author\0on_start_clicked\0\0slot_timer"
};
...
const QMetaObject author::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_author.data,
      qt_meta_data_author,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *author::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_author.stringdata0))
